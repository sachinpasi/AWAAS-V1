...
const Call = () => {
  ...
  return (
    <section className="w-full bg-blue ">
      <div className="lg:w-80vw w-90vw mx-auto flex flex-col justify-center items-center">
        ...
        <div className="w-full flex-col flex lg:justify-between items-center lg:h-28 pt-4">
          <input
          ...
          <button
            ...
            className="lg:w-2/4 w-full h-12 bg-white text-blue lg:ml-2 font-medium text-xl my-2"
          >
            Submit
          </button>
        </div>
